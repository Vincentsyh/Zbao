...
<html>
    ...
    <body>
        <article>
            <div class="picBox">
                <img src="phone/wenxue/3.jpg" alt=""/>
                <img src="phone/bookImage/1.1.jpg" alt=""/>
                <img src="phone/bookImage/1.2.jpg" alt=""/>
                <img src="phone/bookImage/1.3.jpg" alt=""/>
<!--                <img src="phone/wenxue/1.jpg" alt=""/>
        ...
        <div style="margin-left:  400px">
            ...
            <li><p style="font-size: 20px">价&emsp;格：￥${sessionScope.monry}</p></li>
            <li><p style="font-size: 20px">月销量：  1203</p></li>
            </ul>
            <p>
        ...
        <img src="phone/bookImage/1.4.jpg" alt="" width="100%"/>
    </body>
</html>
